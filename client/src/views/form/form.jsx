    ...
    <div className={style.formContainer} onSubmit={submitHandler}>
      <form className={style.container}>
        ...
        <div className={style.temperament}>
          <label className={style.labelTemperaments} htmlFor="temperament">
            Temperaments:
          </label>
            ...
            {allTemperaments.map((temperament) => (
              <div key={temperament}>
                <input
                  ...
                  checked={form.temperaments.includes(temperament)}
                />
                <label className={style.itemTemperament}>{temperament}</label>
              </div>
            ))}
          </div>
        </div>
